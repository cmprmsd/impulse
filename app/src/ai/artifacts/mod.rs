...
// Removed cloud-coupled From / TryFrom impls for `api::message::artifact_event::*`
// and `warp_graphql::ai::AIConversationArtifact` — those crates were deleted
// during the cloud strip.
